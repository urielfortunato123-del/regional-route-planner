  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo falhou no servidor. Tente novamente ou volte ao início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#1c4a48" },
      { title: "Programação e Roteirização Regional" },
      {
        name: "description",
        content:
          "Programação de serviços rodoviários filtrada por regional, com importação de PDF e montagem de rotas de campo.",
      },
